...
AShootTarget::AShootTarget()
{
	...
	if (!MeshComponent)
	{
		...
		static ConstructorHelpers::FObjectFinder<UStaticMesh>Mesh(TEXT("'/Game/ThirdPersonActor/Target/TargetCylinder.TargetCylinder'"));
        if(Mesh.Succeeded())
        {
		...
		static ConstructorHelpers::FObjectFinder<UMaterial>Material(TEXT("'/Game/ThirdPersonActor/Target/TargetMaterial.TargetMaterial'"));
