...
AWeapon::AWeapon()
{
	...
	if (!MeshComponent)
	{
		...
		static ConstructorHelpers::FObjectFinder<USkeletalMesh>Mesh(TEXT("'/Game/ThirdPersonWeapon/FPGun/Mesh/SK_FPGun.SK_FPGun'"));
        if(Mesh.Succeeded())
        {
		...
		static ConstructorHelpers::FObjectFinder<UMaterial>Material(TEXT("'/Game/ThirdPersonWeapon/FPGun/Materials/M_FPGun.M_FPGun'"));
